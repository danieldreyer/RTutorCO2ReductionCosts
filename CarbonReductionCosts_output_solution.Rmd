...
write.csv(main_data2, "X:\\libraries\\RTutor_BA\\main_data3.csv", row.names = FALSE)
...
Quiz: As shown in an earlier exercise, interconnection `ERCOT` has higher generation of renewable energies than `EAST`. Do you expect that `ERCOT` has a higher or lower emission abatement in comparison to `EAST`?
...
**Task:** Just press *check*.
```{r "4_2__53",fig.width=21, fig.height=7}
