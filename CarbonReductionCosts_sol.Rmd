...
In the next step we should always determine if the model fits the data. One possibiliy is to use the $R^2$ indicator, which measures quite low with $19.7%$. The interpretation of this indicator however, should always be taken with caution. As mentioned before, `costratio` is statistically significance, therefore we still can draw conclusions from our results.  
