...
libs = c("dplyr", "ggplot2", "gridExtra", "htmlTable", "stargazer", "pracma", "haven", "tidyverse", "ggalt", "regtools", "splines") # character vector of all packages you load in the problem set
