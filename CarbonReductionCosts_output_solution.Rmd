...
```{r "4_1__44",warning=FALSE, fig.width=7, fig.height=7}
...
```{r "4_1__45",warning=FALSE, fig.width=14, fig.height=7}
...
**Task:** Run the code for the `ERCOT` interconnection. Just press *check*.
```{r "4_2__52",fig.width=7, fig.height=7}
temp_ercot <- dat %>% 
