...
libs = c("dplyr", "ggplot2", "gridExtra", "stargazer", "tidyverse", "ggalt",  "splines", "kableExtra", "scatterplot3d") # character vector of all packages you load in the problem set
