...
### Award: Theorist
Gratulations! You are ready to start with the analysis.
...
**Task:** Just press *check*.
```{r "4_1__39",warning=FALSE, fig.width=7, fig.height=7}
...
```{r "4_1__42",warning=FALSE, fig.width=14, fig.height=7}
...
**Task:** Just press *check*.
```{r "4_2__47",fig.width=7, fig.height=7}
...
**Task:** Just press *check*.
```{r "4_2__50",fig.width=21, fig.height=7}
grid.arrange(plot_east, plot_ercot, plot_wecc, nrow=1)
```
