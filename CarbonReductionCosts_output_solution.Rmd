...
Quiz: Before taking a look at the summary, how do changing cost ratios effect emissions?
...
**Task:** Just press **check**
```{r "3_1__22",fig.width=9, fig.height=6, dev='svg'}
...
To this point we limited our data to fuel prices and generated electricity (`load`). We will use this exercise to add additional factors to our data frame and get a final impression of what we are working with. 

**Task:** Load the data set `main_data.csv` into a variable `dat` and display the first 3 rows.
