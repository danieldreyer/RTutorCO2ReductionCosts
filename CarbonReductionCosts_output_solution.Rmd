...
**Task:** Just press *check*.
```{r "3_2__33",warning=FALSE, dev='svg'}
...
```{r "3_2__34",eval=FALSE, optional=TRUE}
...
```{r "4_1__47",warning=FALSE, fig.width=7, fig.height=7, dev='svg'}
...
```{r "4_1__50",warning=FALSE, fig.width=21, fig.height=7, dev='svg'}
...
**Task:** Just press *check*.
```{r "4_2__57",fig.width=21, fig.height=7, dev='svg', warning=FALSE}
grid.arrange(plot_east, plot_ercot, plot_wecc, nrow=1)
```
