...
EVtl loop ueber "WECC" und "ERCOT" ///////comments
...
#calc carbon tax
tax_east0 <- tibble(date=east$date, co2 = co2.east, priceratio = east$priceratio, base_emit, carbontax=(east$priceratio*basegas-basecoal)/(0.1054-east$priceratio*0.0585), emission=pred_east$transformed.east)
...
**Task:** Just press *check*.
```{r "3_4__50"}
ggplot(tax_east, aes(x=carbontax, y=emission*-1) ) +
  geom_line() +
...
//// einschub robustness test mit anderen definition von priceratios , appendix a2< number of knots
