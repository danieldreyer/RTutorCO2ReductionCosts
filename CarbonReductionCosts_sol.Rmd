...
newrow = data.frame(tax=seq(0,80,10), east_emission=round(function_name(tax_east)/100000,1), ercot_emission=round(function_name(tax_ercot)/100000,1), wecc_emission=round(function_name(tax_wecc)/100000,1))
...
test <- newrow %>% 
  mutate(perc_east=round((1-newrow$east_emission/newrow$east_emission[1])*100,1),
         ...
         perc_all=round((1-test$emission_all/test$emission[1])*100,1))  

test2 <- test[,c(1,2,5,3,6,4,7,8,9)]
test2
