...
libs = c("dplyr", "ggplot2", "gridExtra", "htmlTable", "stargazer", "reshape2", "pracma", "haven", "tidyverse", "ggalt") # character vector of all packages you load in the problem set
...
In the following section we will estimate the following model:
