...
list <- c("Power Plants", "Power Plants, Refineries", "Power Plants, Suppliers of CO2", "Power Plants, Waste")
list
...
temp <- temp %>%
  mutate(Industry.Type..sectors. = ifelse(!Industry.Type..sectors.%in%list,"Andere",Industry.Type..sectors.)) 
...
ggplot(temp1, aes(fill=Industry.Type..sectors., y=emission, x=Reporting.Year)) + 
