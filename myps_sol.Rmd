...
libs = c("dplyr", "ggplot2", "choroplethr", "lfe", "gridExtra", "evd", "htmlTable", "stargazer", "magick", "reshape2", "pracma", "haven") # character vector of all packages you load in the problem set
