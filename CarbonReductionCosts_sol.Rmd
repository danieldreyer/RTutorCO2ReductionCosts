...
#< quiz "Cost Ratios"
question: What happens to our cost ratio accorging to Equation 2, if natural gas doubles in costs and coal costs goes down by 25%.
sc:
    - Rise
    - Equal
    - Fall*
...
#< quiz "carbon Prices"
question: Can we create any cost ratio under the assumption that we introduce carbon prices under fixed fuel prices?
sc:
    - Yes*
    - No
success: Great, your answer is correct!
...
```{r "4_1__9",warning=FALSE, fig.width=7, fig.height=7, dev='svg'}
#< task_notest
...
```{r "4_1__12",warning=FALSE, fig.width=21, fig.height=7, dev='svg'}
