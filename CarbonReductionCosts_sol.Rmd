...
#< quiz "Reg1"
question: Before looking at the summary, what impact do changing cost ratios have on emissions?
...
The summary statistics of our spline model is comparable to the one of simple polynomial regressions. We get a coefficient for every knot. Since splines are transformations of explanatory variables it isn't possible to interpret these coefficients straightforward. Because of that reason we went through the trouble of introducing the method of plotting regression models.  
...
head(dat,3)
#< hint
display("Fill in the right variable names and the front and end. To show the first few rows of the data frame, ust head().")
#>
```
&nbsp;
