...
**Task:** Just press *check*.
```{r "4_1__45",warning=FALSE, fig.width=7, fig.height=7}
...
```{r "4_1__48",warning=FALSE, fig.width=14, fig.height=7}
...
**Task:** Just press *check*.
```{r "4_2__53",fig.width=7, fig.height=7}
...
**Task:** Just press *check*.
```{r "4_2__56",fig.width=21, fig.height=7}
grid.arrange(plot_east, plot_ercot, plot_wecc, nrow=1)
```
